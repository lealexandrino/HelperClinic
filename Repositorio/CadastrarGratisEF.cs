            ...
            try
            {
                if (contexto.LogIn.Where(x => x.Email == _model.LogIn.Email).Count() == 0)
                {
                    if (contexto.LogIn.Where(x => x.Clinica == _model.LogIn.Clinica).Count() == 0)
                    {
                        ...
                        _model.Empresa.Nome = _model.LogIn.Nome;
                        ...
                        _model.LogIn.CodEmpresa = _model.Empresa.Id;
                ...
                {
                    _model.Util.Mensagem = "E-mail já cadastrado em nosso banco de dados. Entre em contato com o helper clinic";
                }
            }
            catch(Exception ex)
            {
