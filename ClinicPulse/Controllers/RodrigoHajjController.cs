...
{
    public class RodrigoHajjController : Controller
    {
        // GET: RodrigoHajj
        ...
        public bool MandarEmail(string email, string assunto, string nome, string body)
        {
            try
            {
                ...
                myMail.Body = body + " <br /> Email de:" + email + "<br /> Nome da Pessoa:" + nome + "<br /> Site Leandro Alexandrino"; //"<b>Test Mail</b><br>using <b>HTML</b>.";
